...
//by ernst
public class EntityVulnerable implements EntityBase, Collidable {
    ...
    public void Init(SurfaceView _view) {
        ...
        spritesheet = new Sprite(ResourceManager.Instance.GetBitmap(R.drawable.powerupyellowbolt),1,1,1);
        spritesheet.Scale(50,50);
    ...
    public static EntityVulnerable Create()
    {
        EntityVulnerable result = new EntityVulnerable();
        EntityManager.Instance.AddEntity(result,ENTITY_TYPE.ENT_COLLECTIBLE);
        return result;
    }

    public static EntityVulnerable Create(int _layer)
    {
        EntityVulnerable result = Create();
